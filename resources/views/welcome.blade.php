                  ...
                  <div class="container-scroller">
                      ...
                      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                          <div
                              ...
                              <a class="navbar-brand brand-logo-mini" href="{{ route('/.index') }}"><img src="images/logo-mini.svg"
                                      alt="logo" /></a>
                          </div>
                              ...
                              <ul class="navbar-nav navbar-nav-right">
                                  ...
                                  <li class="nav-item nav-profile dropdown">
                                      <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
                                          id="profileDropdown">
                                          <img src="images/webmavens.png" alt="profile" />
                                      </a>
                                      ...
                                      <div class="collapse" id="ui-basic">
                                          <ul class="nav flex-column sub-menu">
                                            <li class="nav-item"> <a class="nav-link"
                                                href="{{ route('companies.create') }}">Companies Add</a></li>
                                              <li class="nav-item"> <a class="nav-link"
                                                      href="{{ route('companies.index') }}">Companies Data</a></li>
                                          </ul>
                                      </div>
                                  </li>
                                  <li class="nav-item">
                                      ...
                                      <div class="collapse" id="form-elements">
                                          <ul class="nav flex-column sub-menu">
                                            <li class="nav-item"><a class="nav-link" href="{{ route('employees.create') }}">Employees Add</a></li>

                                              <li class="nav-item"><a class="nav-link" href="{{ route('employees.index') }}">Employees Data</a></li>
                                          </ul>
                                      </div>
                                  </li>
                              ...
                              <footer class="footer">
                                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                      <span
                                          ...
                                          © 2021. Premium <a href="{{ route('/.index') }}"
                                              target="_blank">devloped by</a> SANDIP SONAGRA .
                                  ...
                                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                      <span
                                          ...
                                          by <a href="https://www.themewagon.com/"
                                              target="_blank">Sandip Sonagra</a></span>
                                  </div>
                              </footer>
                              <!-- partial -->
                          </div>
