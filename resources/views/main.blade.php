        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                {{-- <li class="nav-item dropdown"> --}}
                    <form action="{{ url('lang') }}" method="post" id="langform" >
                        @csrf
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="{{ route('dashboard.index', ['lang' => 'en']) }} }}" class="dropdown-item">

                        <div class="media">
                            <img src="{{ asset('dist/img/english.png') }}" alt="User Avatar"
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-sm">defult language</p>
                        ...
                        <a href="{{route('dashboard.index', ['lang' => 'hi']) }}" class="dropdown-item">

                        <div class="media">
                            <img src="{{ asset('dist/img/hindi.png') }}" alt="User Avatar"
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-sm">भारत की राष्ट्र भाषा
                                </p>
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="{{ route('dashboard.index', ['lang' => 'gu']) }}" class="dropdown-item">

                        <div class="media">
                            <img src="{{ asset('dist/img/gujrati.png') }}" alt="User Avatar"
                                class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    ગુજરાતી
                                ...
                                <p class="text-sm">વિશ્વની ભાષામાં શ્રેષ્ઠ</p>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('companies.create') }}" class="nav-link active">
